...
export const GlareCard = ({
  ...
  return (
    <div
      ...
      className="group relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-full h-full"
      ref={refElement}
      onPointerMove={(event) => {
      ...
      <div
        ...
        <div
          ...
          {/* 🎯 FIX 2: Ensure project/content sits above overlays */}
